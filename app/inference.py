...
def app():
    ...
    fname = 'data/country_shape/gadm41_USA_0.shp'
    ...
    if st.button("Predict"):
        ...
        with st.spinner('Making prediction for ' + selected_month + ' - 2020 ...'):
            ...
            inverse_multipoly = [Polygon([(-180, -90), (-180, 90), (180, 90), (180, -90)],
            ...
            ax.set_extent([-125.000000, -66.934570, 24.396308, 49.384358], ccrs.PlateCarree())
            ax.axis("off")
